<template>
  <div :class="this.side ? 'sidebar-main-min' : 'sidebar-main-max'" @mousemove="side = false" @mouseleave="side = true">
    ...
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_EMPLOYEE']) ? '' :'side-position-disabled']" @click="submit('myRecord')">
      {{this.$t("label.scrollMenu.label.my")}}</label>
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_COMPANY_OWNER']) ? '' :'side-position-disabled']" @click="submit('companyRecord')">
    ...
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_COMPANY_OWNER']) ? '' :'side-position-disabled']" @click="submit('addEmployee')">
      {{this.$t("label.scrollMenu.label.add")}}</label>
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_EDIT_EMPLOYEE']) ? '' :'side-position-disabled']" @click="submit('editEmployee')">
    ...
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_COMPANY_OWNER']) ? '' :'side-position-disabled']" @click="submit('settingsCompany')">
      {{this.$t("label.scrollMenu.label.settingsCompany")}}</label>
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_COMPANY_OWNER']) ? '' :'side-position-disabled']" @click="submit('settingsService')">
      {{this.$t("label.scrollMenu.label.services")}}</label>
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_COMPANY_OWNER']) ? '' :'side-position-disabled']" @click="submit('settingsSchedule')">
    ...
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_COMPANY_OWNER']) ? '' :'side-position-disabled']" @click="submit('statisticCompany')">
      {{this.$t("label.scrollMenu.label.byCompany")}}</label>
    <label v-if="!this.side" :class="['side-position', isEnabled(['ROLE_COMPANY_OWNER','ROLE_EMPLOYEE']) ? '' :'side-position-disabled']" @click="submit('statisticEmployee')">
